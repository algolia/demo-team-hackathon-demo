...
const Carousel = () => {
  return (
    <Index indexName={'mate_team_off_white_ns'} indexId={'recommend-carousel'}>
      ...
      <div className="bg-colorBp-100 px-3 rounded-md my-8 pb-8 pt-4 md:px-8">
        <div className="mx-auto w-full max-w-screen-2xl">
          <h2 className="mb-3 text-center text-base font-semibold leading-none text-[#000034] lg:text-xl">Recommended for you</h2>
          <CarouselHits />
        </div>
      </div>
    </Index>
